...
const { currentBook, selectedTestimonis, selectedReasons, footers } =
    usePage().props;
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div class="mb-8">
                        ...
                        <div
                            v-if="selectedTestimonis.length > 0"
                        ...
                        <p v-else class="text-red-500">
                            Belum ada testimoni yang dipilih.
                        </p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div
                            ...
                            class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 gap-4"
                        >
                            <div
