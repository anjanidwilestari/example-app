...
<template>
  <section>
    ...
    <AuthenticatedLayout>
      <template #header>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Reason</h2>
      </template>
          ...
          <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <form @submit.prevent="submitForm" class="mt-6 space-y-6" enctype="multipart/form-data">
              ...
              <div class="flex items-center gap-4">
                ...
                <p v-if="form.recentlySuccessful" class="text-sm text-gray-600">Reason berhasil disimpan!</p>
              </div>
            </form>
          </div>
        </div>
