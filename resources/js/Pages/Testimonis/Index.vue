                            ...
                            <table class="w-full">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td class="px-4 py-2 border">
                                            {{
                                                truncateReview(testimoni.review)
                                            }}
                                        </td>
                                        ...
                                        <td class="px-4 py-2 border">
                                            <div
                                                ...
                                                class="bg-green-500 text-white rounded-md px-3 py-1 text-xs"
                                            >
                                                Aktif
                                            </div>
                                            <div
                                                v-else
                                                class="bg-gray-400 text-white rounded-md px-3 py-1 text-xs"
                                            >
                                                Non-Aktif
                                            </div>
                                        </td>
